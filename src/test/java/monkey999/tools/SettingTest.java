...
class SettingTest {
    ...
    final String propertiesPath = new File(getClass().getClassLoader().getResource("setting.properties").getFile()).getAbsolutePath();
    final String propertiesPath_dummy =new File(getClass().getClassLoader().getResource("setting_dummy.properties").getFile()).getAbsolutePath();
    final String propertiesPath_forGetAll =  new File(getClass().getClassLoader().getResource("setting_forGetAll.properties").getFile()).getAbsolutePath();
     ...
     */
    @Test
    @DisplayName("get env success")
    void getAsString_getEnvSuccess() {
        Setting.init(propertiesPath);
